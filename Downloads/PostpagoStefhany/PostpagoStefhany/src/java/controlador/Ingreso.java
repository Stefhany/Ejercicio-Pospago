...
public class Ingreso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("btnIngresarC") != null && request.getParameter("ingresarC") != null) {
                PersonaDTO pdto = new PersonaDTO();
                PersonaDAO pdao = new PersonaDAO();
                pdto = pdao.validarUsuarioV2(Integer.parseInt(request.getParameter("txtCedula")),request.getParameter("txtClave"));
                if (pdto.getPerId() != 0) {
